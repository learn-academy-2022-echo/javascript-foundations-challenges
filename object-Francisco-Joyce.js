...
// console.log(`${person.firstName} ${person.lastName}'is from planet earth'`)
...
// const myLunch = (string) => {
//   return `The ingredients for a ${lunch.name} sandwich are ${lunch.ingredients[0,1]} and ${lunch.ingredients[2]}`
// }
...
// // Output: ["2021 Alpha", "2021 Bravo", "2021 Charlie", "2021 Delta", "2021