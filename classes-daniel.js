...
class Coffee {
  ...
  // class Latte {
  //   constructor(flavor, milk, numShots) {
  //     this.flavor = flavor;
  //     this.milk = milk;
  ...
  class Latte {
    ...
    latteProfile() {
      return `A ${this.flavor} latte with ${this.milk} milk and ${this.numShots} shots of espresso`
    }
  }
  
  // Write the code that makes a regular, single shot latte. Then, log the latte's profile.
  
  const singleShot = new Latte('mocha', 'almond', "1")
  ...
  // Write the code that creates three unique cylinder objects
  const cylOne = new Cylinder(5, 8)
  const cylTwo = new Cylinder(10, 9)
  const cylThree = new Cylinder(12, 18)
